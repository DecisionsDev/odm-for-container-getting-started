...
This tutorial is for technical and business users who want an introduction to business rules authoring and management with IBM Operational Decision Manager (ODM) running in a container environment. Here are the different offerings where you can use this Getting Started tutorial:
   ...
   * [IBM Operational Decision Manager for Developers on Certified Kubernetes]([https://artifacthub.io/packages/helm/ibm-charts/ibm-odm-dev/22.2.0](https://artifacthub.io/packages/helm/ibm-odm-charts/ibm-odm-dev) - To deploy ODM on Certified Kubernetes environments, for evaluation and development purposes. 
